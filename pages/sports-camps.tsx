                    ...
                    <Stack px={mobile ? rem(12) : queryMd ? rem(24) : rem(48)} gap={mobile ? rem(24) : queryMd ? rem(48) : rem(96)} align='center'>
                        ...
                        <Stack w={'100%'} align='center'>
                            ...
                            <Stack gap={mobile ? 32 : 96}>
                                ...
                                <SportVillageItem
                                    ...
                                    desc={`На территории спортивной деревни расположены разные спортивные объекты: 4 летних шатра с покрытием из доски, 1 летний шатер 
                                        с резиновым покрытием, большая воркаут площадка, круговая беговая дорожка 450 м, где 300 м – тротуарная плитка, 
                                        150 м – резиновая крошка. Также на территории деревни установлен автомат с бесплатной чистой питьевой водой.`}
                                    id={'sportobj'}
                        ...
                        <Stack py={mobile ? rem(24) : queryMd ? rem(48) : rem(96)} gap={mobile ? 12 : 24} w={'100%'}>
                            ...
                            <Grid gutter={24}>
                                ...
                                <SportObjectVariant
                                    title='Пляжный центр'
                                    desc='Единственный в Тульской области манеж с кварцевым подогреваемым песком.'
                                    img={DEFAULTS.URL.CDN + '/img/sports-camps/beach-center.webp'}
                                    content={<BeachCenter />}
                                />
                                <SportObjectVariant
                                    title='Спортивный манеж'
                                    desc='Спортивный манеж позволяет спортсменам тренироваться круглый год, независимо от погодных условий.'
