                        ...
                        <Stack gap={20} maw={700}>
                            <Stack gap={4}>
                                ...
                                <Stack gap={4}>
                                    ...
                                    <Text fz={isMobile ? 15 : 16} fw={400}>Обе опции предоставляются по предварительному согласованию с администратором <SNW>и оплачиваются</SNW> дополнительно — 50% от стоимости номера.</Text>
                                </Stack>
                            </Stack>
                            <Stack gap={4}>
                                <Text fz={isMobile ? 18 : 20} fw={700}>Оплата и отмена бронирования</Text>
                                <Stack gap={6}>
                                    <Text fz={isMobile ? 16 : 17} fw={600}>Общие условия:</Text>
                                    <Text fz={isMobile ? 15 : 16} fw={400}>
                                        При бронировании взимается предоплата в размере 1 суток проживания.
                                    </Text>
                                    <Text fz={isMobile ? 15 : 16} fw={400}>
                                        В случае отмены менее чем за 7 суток до даты заезда, предоплата не возвращается,
                                        <SNW> за исключением</SNW> ситуаций, индивидуально согласованных с администратором.
                                    </Text>
                                    <Text fz={isMobile ? 15 : 16} fw={400}>
                                        По вопросам возврата денежных средств:
                                        <SNW>
                                            <a style={{ color: '#252525', textDecoration: 'underline' }} href='tel:+79101681761'> +7 (910) 168-17-61</a>
                                    ...
                                    <Text fz={isMobile ? 15 : 16} fw={400}>
                                        Возврат предоплаты возможен только при аннуляции не позднее чем за <b>60 суток</b> до даты заезда.
                                    </Text>
                                    <Text fz={isMobile ? 15 : 16} fw={400}>
                            ...
                            <Stack gap={4}>
                                ...
                                <Text fz={isMobile ? 15 : 16} fw={400}>Услуга проживания с животным приобретается дополнительно.</Text>
                                <Stack gap={8}>
                                    <Stack gap={4}>
                                        <Text fz={isMobile ? 15 : 16} fw={600}>До 10 января:</Text>
                                        <List size={'xs'} styles={{ itemLabel: { fontSize: isMobile ? 15 : 16 }, item: { paddingBlock: 2 } }}>
                                            <List.Item>Доп. место для животного до 7 кг. - <SNW>доплата 1000 ₽/сутки</SNW></List.Item>
                                        </List>
                                    </Stack>
                            ...
                            <Stack gap={8}>
                                ...
                                <Stack gap={4}>
                                    <Text fz={isMobile ? 15 : 16} fw={600}>Номера, в цену которых указанные услуги включены:</Text>
                                    <Stack gap={4}>
