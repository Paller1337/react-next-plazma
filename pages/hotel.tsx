                        ...
                        <Stack gap={20} maw={700}>
                            ...
                            <Stack gap={4}>
                                ...
                                <Stack gap={4}>
                                    ...
                                    <Text fz={isMobile ? 15 : 16} fw={400}>В случае отмены менее чем за 7 суток до даты заезда, предоплата не возвращается, <SNW>за исключением</SNW> ситуаций, индивидуально согласованных с администратором.</Text>
                            ...
                            <Stack gap={8}>
                                ...
                                <Stack gap={4}>
                                    <Text fz={isMobile ? 15 : 16} fw={600}>Перечень категорий размещения, для которых указанные услуги включены <SNW>в стоимость:</SNW></Text>
                                    <Stack gap={4}>
                                ...
                                <Stack gap={4}>
                                    ...
                                    <Text fz={isMobile ? 15 : 16} fw={400}>Проживающие в данных номерах могут приобрести услугу дополнительно — 800 ₽ <SNW>с человека (от 5 лет).</SNW></Text>
                                </Stack>
                            </Stack>
