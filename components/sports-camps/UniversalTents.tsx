        ...
        <Stack miw={'80%'} gap={24}>
            <Stack gap={8}>
                ...
                <Text size={mobile ? 'xs' : 'sm'}>
                    На территории расположены 5 шатров: 4 покрыты лакированной доской, 
                    что делает их подходящими для тренировок, занятий танцами и гимнастикой. 
                    Они могут трансформироваться под различные задачи и обеспечивают удобное 
                    укрытие в любую погоду. Пятый шатер оснащен покрытием из резиновой крошки 
                    и баскетбольными кольцами, создавая отличные условия для спортивных игр.
                </Text>
            </Stack>
