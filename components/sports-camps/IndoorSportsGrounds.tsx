        ...
        <Stack miw={'80%'} gap={24}>
            <Stack gap={8}>
                ...
                <Text size={mobile ? 'xs' : 'sm'}>
                    Крытые универсальные площадки с паркетным покрытием можно адаптировать
            ...
            >
                ...
                условия для интенсивных тренировок. Эти крытые площадки доступны круглый год, позволяя спортсменам тренироваться
