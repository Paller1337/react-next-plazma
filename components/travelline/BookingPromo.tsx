...
export default function BookingPromo(props: any) {
    ...
    return (<>
        ...
        {/* {tlIsLoad ? */}
        <div className={`main__promo-tl `}
            // style={{ opacity: tlIsLoad ? 1 : 0 }}
        >
            <div id='block-search'>
                <div id='tl-search-form' className='tl-container'>
                    <noindex><a href='https://www.travelline.ru/products/tl-hotel/' rel="nofollow noreferrer" target='_blank'>TravelLine</a></noindex>
                </div>
            </div>
        </div>
        {/* : <></>} */}
