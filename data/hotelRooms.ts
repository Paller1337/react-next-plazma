...
export const hotelRooms: RoomObjectProps[] = [
    ...
    //     image: '/img/hotel/promo-slides/1.jpg',
    //     size: 'Размер номера 26 м².',
    //     attributes: [
    //         { name: 'Цены', value: 'воскресенье - четверг <b>14450 руб/сутки</b>;</br> пятница и суббота <b>17450 руб/сутки</b>' },
    //         { name: 'Вместимость', value: '8 человек. 6 взрослых и 2 детей до 12 лет.' }
    //     ],
    //     amenities: [
...

    {
        ...
        image: '/img/hotel/room-previews/module-house.jpg',
    ...
    },
    {
        ...
        image: '/img/hotel/room-previews/austr-townhouse.jpg',
    ...
    },
    {
        ...
        title: 'Делюкс на набережной',
        description: 'Новый корпус на набережной с прекрасным видом на водоём.',
        image: '/img/hotel/room-previews/deluxe-5-corps.jpg',
        size: 'Размер номера 26 м².',
        attributes: [
    ...
    },
    {
        ...
        image: '/img/hotel/room-previews/comfort-sauna.jpg',
    ...
    },
    {
        ...
        image: '/img/hotel/room-previews/sports-corps-2.jpg',
    ...
    },
    {
        ...
        image: '/img/hotel/room-previews/comfort.jpeg',
...

    {
        ...
        image: '/img/hotel/room-previews/cottage.jpeg',
    ...
    },
    {
        ...
        title: 'Таунхаус',
        description: 'Просторный номер класса "Люкс" с панорамным видом на море.',
        image: '/img/hotel/room-previews/townhouse.jpeg',
    ...
    },
    {
        ...
        title: 'Евростандарт',
        description: 'Просторный номер класса "Люкс" с панорамным видом на море.',
        image: '/img/hotel/room-previews/eurostandard.jpeg',
    ...
    },
    {
        ...
        image: '/img/hotel/room-previews/deluxe-balcony.jpeg',
        size: 'Размер номера 25 м².',
        attributes: [
    ...
    },
    {
        ...
        description: 'Однокомнатный номер на двоих. Корпус находится в 30 метрах от основной территории парк-отеля через дорогу.',
        image: '/img/hotel/room-previews/eurostandard-sport-corps.jpeg',
